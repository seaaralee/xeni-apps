  ...
  return (
    <View style={[styles.container, themeContainerStyle]}>
      <SafeAreaView style={styles.AndroidSafeArea}>
        ...
        >
          <Text style={{textAlign:'center', color: '#755F86', fontSize: 18, fontWeight: '500'}}>Xerapan Quiz</Text>
          ...
          <View style={{flexDirection: 'row', justifyContent:'space-around', marginTop: 9}}>
            <IconPage title="Easy"/>
            <IconPage title="Medium"/>
            <IconPage title="Hard"/>
          </View>
          <View style={{marginTop: 32}}>
            <Text style={{ color: '#755F86', fontSize: 18, fontWeight: '500'}}> Quiz History </Text>
          </View>
          <View style={{alignItems: 'center', justifyContent: 'center', marginTop: "20%"}}>
            <Image source={require("../assets/nothing.png")}/>
            <Text style={{marginTop: 16, fontSize: 12, color: "#755F86CC", opacity: '80%' }}>Nothing to see your history now :( </Text>
          </View>
        </View>
      </SafeAreaView>
    </View>

...
export default function QuizMediumDetailScreen({ navigation }) {
        ...
        <View style={[styles.container, themeContainerStyle]}>
            <SafeAreaView style={styles.AndroidSafeArea}>
                ...
                <View style={{ margin: 16, justifyContent: "space-between", alignItems: "center", flexDirection: "row", }}>
                    <Ionicons name="arrow-back" size={22} color="#FFFFFF" onPress={() => navigation.navigate("QuizMedium")} />
                    <Text style={styles.title}> Medium Quiz </Text>
                ...
                <View style={styles.quizcontainer}>
                    ...
                    <View style={{ justifyContent: "center", alignItems: "center" }}>
                        ...
                        <View style={{ marginTop: "15%", justifyContent: "center", alignItems: "center" }}>
                            ...
                            <Text style={styles.txtquiz}>Ini pertanyaannya</Text>
                        </View>
                    </View>

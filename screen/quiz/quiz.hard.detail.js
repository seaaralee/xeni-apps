...
export default function QuizHardDetailScreen({ navigation }) {
        ...
        <View style={[styles.container, themeContainerStyle]}>
            <SafeAreaView style={styles.AndroidSafeArea}>
                ...
                <View style={{ margin: 16, justifyContent: "space-between", alignItems: "center", flexDirection: "row", }}>
                    <Ionicons name="arrow-back" size={22} color="#FFFFFF" onPress={() => navigation.navigate("QuizHard")} />
                    <Text style={styles.title}> Hard Quiz </Text>
